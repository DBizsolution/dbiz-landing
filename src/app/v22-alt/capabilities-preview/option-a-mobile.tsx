...
export function OptionAMobile() {
  ...
  return (
    <section className='v22alt-section' id='cap-a-mobile'>
      <div className='v22alt-container'>
        <div className='v22alt-section-head'>
          <div className='num'>Option A / Mobile</div>
          <h2>The stack,<br /><span style={{ color: 'var(--v22alt-accent)' }}>in your pocket.</span></h2>
              ...
              <div key={cap.num} className={`capAm-row ${isOpen ? 'is-open' : ''}`} role='listitem'>
                ...
                >
                  ...
                  <svg viewBox='0 0 72 44' className='capAm-row-mark' aria-hidden='true'>
                    ...
                    <circle r='2.6' fill='var(--v22alt-accent)' opacity='0'>
                      <animate
                        attributeName='cy'
                        values='14;40;40'
                        keyTimes='0;0.143;1'
                    ...
                    <circle r='1.6' fill='var(--v22alt-accent)'>
                      <animate
                        attributeName='cy'
                        values='14;40;40'
                        keyTimes='0;0.143;1'
                    ...
                    <circle cx='64' cy='20' r='1.4' fill='var(--v22alt-accent)' opacity='0'>
                      <animate
                        attributeName='opacity'
                    ...
                    {i < capabilities.length - 1 && (
                      <circle r='1.2' fill='var(--v22alt-accent)' opacity='0'>
                        <animate
                          attributeName='cy'
                          values='40;44;40'
                          keyTimes='0;0.143;1'
