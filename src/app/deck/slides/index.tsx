...
export const slides: SlideEntry[] = [
  ...
  { marker: 'S·06', act: 'Act 1', title: 'BRD + AI · the setup', time: '30s', Component: Slide06Setup },
  ...
  { marker: 'S·13', act: 'Act 2', title: 'The canvas in one breath', time: '1m', Component: Slide13Canvas },
  { marker: 'S·14', act: 'Act 2', title: 'Same source, two uses', time: '30s', Component: Slide14TwoUses },
  ...
  { marker: 'S·22', act: 'Act 3', title: 'Phase 0 · Working repository', time: '1m', Component: Slide22WorkingRepo },
  { marker: 'S·23', act: 'Act 3', title: 'Phase 1 · Stages and lifecycle', time: '2m', Component: Slide23Stages },
  { marker: 'S·24', act: 'Act 3', title: 'Phase 2 · Data dictionary', time: '2m', Component: Slide24DataDictionary },
  { marker: 'S·25', act: 'Act 3', title: 'Phase 3 · How the app is laid out', time: '2m', Component: Slide25RouteMap },
  { marker: 'S·26', act: 'Act 3', title: 'Phase 4a · Design system', time: '1m 30s', Component: Slide26DesignSystem },
  { marker: 'S·27', act: 'Act 3', title: 'Phase 4b · Flows index', time: '45s', Component: Slide27FlowsIndex },
  { marker: 'S·28', act: 'Act 3', title: 'Phase 4c · Coverage view', time: '45s', Component: Slide28Coverage },
  { marker: 'S·29', act: 'Act 3', title: 'Phase 5 · The build, honestly', time: '2m 30s', Component: Slide29BuildHonestly },
  { marker: 'S·30', act: 'Act 3', title: 'Phase 6a · Feedback tracker', time: '1m', Component: Slide30FeedbackTracker },
  { marker: 'S·31', act: 'Act 3', title: 'Phase 6b · A live screen', time: '30s', Component: Slide31LiveScreen },
  { marker: 'S·32', act: 'Close', title: 'Close · what shipped', time: '1m', Component: Slide32Close },
  { marker: 'S·33', act: 'Close', title: 'Q&A', time: '5–7m', Component: Slide33QA },
]
