...
const FILL_TOP = 'var(--v21-iso-top, #11203f)'
const FILL_FRONT = 'var(--v21-iso-front, #0a1733)'
const FILL_RIGHT = 'var(--v21-iso-right, #060e22)'
  ...
  return (
    <g className='av-callout'>
      ...
      <text x={end[0]} y={end[1] - 18} fontFamily='var(--font-mono)' fontSize='9'
        fill='var(--v21-ink-label)' textAnchor='middle' letterSpacing='2'>
        {code}
      </text>
        ...
        return (
          <g key={`dim-${i}`}>
            ...
            <text x={mx} y={my + 14} fontFamily='var(--font-mono)' fontSize='8.5'
              fill='var(--v21-ink-label)' textAnchor='middle' letterSpacing='1.5'>{s.dx}</text>
          </g>
        )
      })}
  ...
  return (
    <g className='av-dim'>
      ...
      <text x={ax - 6} y={(ay + by) / 2 + 4} fontFamily='var(--font-mono)' fontSize='8.5'
        fill='var(--v21-ink-label)' textAnchor='end' letterSpacing='1.5'>12</text>
      <text x={bx - 6} y={(by + cy) / 2 + 4} fontFamily='var(--font-mono)' fontSize='8.5'
        fill='var(--v21-ink-label)' textAnchor='end' letterSpacing='1.5'>50</text>
    </g>
  )
}
...
function AlgorithmIso() {
  return (
    <svg viewBox={`0 0 ${W} ${H}`} xmlns='http://www.w3.org/2000/svg'
      ...
      <text x={W - 50} y='34' fontFamily='var(--font-mono)' fontSize='9' fill='var(--v21-ink-label-strong)' textAnchor='end' letterSpacing='1'>SHEET A2 · REV 0.2</text>
      ...
      {(() => {
        ...
        return (
          <g>
            ...
            <text x={ox - 6} y={oy - 40} fontFamily='var(--font-mono)' fontSize='8' fill='var(--v21-ink-label)' letterSpacing='1.5'>ISO 30°</text>
          </g>
        )
      })()}
